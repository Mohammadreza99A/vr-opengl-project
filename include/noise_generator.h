...
public:
    ...
    void setup(uint noise_start_seg, uint noise_levels, float noise_start_factor, float noise_factor, NoiseFunctionSelect noise)
    {
    ...
    void set_noise_function(NoiseFunctionSelect noise_func)
    {
    ...
    // NoiseGenerator& operator=(const NoiseGenerator& input){
    //    NoiseGenerator ret(input);
    //    return ret;
    // }

    // NoiseGenerator(const NoiseGenerator& old)
    // {
    //    size = old_str.size;
    //    s = new char[size+1];
    //    strcpy(s, old_str.s);
...
protected:
    ...
    float noise_factor;
    NoiseFunctionSelect noise_func_select;
