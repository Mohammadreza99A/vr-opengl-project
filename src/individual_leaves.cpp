...
IndividualLeaves::IndividualLeaves()
{
}
...
void IndividualLeaves::init(GLuint pid, GLuint _vao)
{
...
void IndividualLeaves::generate()
{
    mat_vector.clear();
    pos_vector.clear();
    float incr = 0.12f;
...
void IndividualLeaves::generate(std::vector<glm::mat4> end_point_matrices)
{
    mat_vector.clear();
    pos_vector.clear();
...
void IndividualLeaves::build_matrices()
{
    GLuint _vbo_transf;
...
uint IndividualLeaves::get_nb_leaves_to_draw()
{
    return nb_leaves_to_draw;
}

std::vector<glm::mat4x4> IndividualLeaves::get_mat_vector()
{
    return mat_vector;
}

std::vector<glm::vec3> IndividualLeaves::get_pos_vector()
{
    return pos_vector;
}

void IndividualLeaves::draw()
{
