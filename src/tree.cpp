...
Tree::~Tree()
{
    ...
    delete this->trunk_shader;
    delete this->ileaves_shader;
}
...
void Tree::set_enabled(bool enabled)
{
    this->enabled = enabled;
}

void Tree::draw_trunks()
{
...
void Tree::move_leaves(float time_delta)
{
...
void Tree::setMVP(glm::mat4 model, glm::mat4x4 view, glm::mat4 perspective)
{
...
void Tree::setLightPos(GLfloat *light_position)
{
